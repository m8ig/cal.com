...
ENV NEXT_PUBLIC_WEBAPP_URL=http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER \
  NEXT_PUBLIC_WEBSITE_URL=http://NEXT_PUBLIC_WEBSITE_URL_PLACEHOLDER \
...
ENV NEXT_PUBLIC_WEBAPP_URL=$NEXT_PUBLIC_WEBAPP_URL \
  ...
  BUILT_NEXT_PUBLIC_WEBSITE_URL=$NEXT_PUBLIC_WEBSITE_URL

RUN scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBAPP_URL}
RUN scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBSITE_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBSITE_URL}
